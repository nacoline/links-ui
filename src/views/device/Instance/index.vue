<template>
    <page-container>
        ...
        <FullPage>
            <!-- <div>位置line 9</div> -->
            <video width="875" controls>
                <source src="http://47.121.143.22:9000/videos/mg400.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video>
            <video width="277" controls>
                <source src="http://47.121.143.22:9000/videos/grab.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video>
            <JProTable
                ref="instanceRef"
                ...
                <template #card="slotProps">
                    ...
                    >
                        ...
                        <template #content>
                            ...
                            <!-- <div>
                                <video controls>
                                    <source src="/videos/mg400.mp4" type="video/mp4">
                                    Your browser does not support the video tag.
                                </video>
                            </div> -->
                        </template>
